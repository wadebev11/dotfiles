...
- Don't add preemptive returns for logic control flow. Instead use positive if statements. Multiple returns in a function
  make it harder to reason about its return type as well as what it does
